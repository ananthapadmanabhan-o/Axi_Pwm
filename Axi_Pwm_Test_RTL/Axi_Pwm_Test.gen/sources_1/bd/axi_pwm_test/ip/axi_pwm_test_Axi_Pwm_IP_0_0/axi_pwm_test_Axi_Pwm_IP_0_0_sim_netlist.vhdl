...
-- Date        : Fri May 29 15:10:45 2026
-- Host        : lonewolf-pc running 64-bit Ubuntu 24.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/lonewolf/Vivado/beginner_projects/Axi_Pwm_Test/Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ip/axi_pwm_test_Axi_Pwm_IP_0_0/axi_pwm_test_Axi_Pwm_IP_0_0_sim_netlist.vhdl
-- Design      : axi_pwm_test_Axi_Pwm_IP_0_0
...
entity axi_pwm_test_Axi_Pwm_IP_0_0_pwm is
  port (
    pwm_out : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    pwm_out0_carry_0 : in STD_LOGIC_VECTOR ( 7 downto 0 );
    s00_axi_aresetn : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axi_pwm_test_Axi_Pwm_IP_0_0_pwm : entity is "pwm";
end axi_pwm_test_Axi_Pwm_IP_0_0_pwm;

architecture STRUCTURE of axi_pwm_test_Axi_Pwm_IP_0_0_pwm is
  ...
  signal slow_counter : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \slow_counter[0]_i_1_n_0\ : STD_LOGIC;
  signal \slow_counter[0]_i_3_n_0\ : STD_LOGIC;
  signal slow_counter_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal \slow_counter_reg[0]_i_2_n_0\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_1\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_2\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_3\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_4\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_5\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_6\ : STD_LOGIC;
  signal \slow_counter_reg[0]_i_2_n_7\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_0\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_1\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_2\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_3\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_4\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_5\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_6\ : STD_LOGIC;
  signal \slow_counter_reg[4]_i_1_n_7\ : STD_LOGIC;
  signal \slow_counter_reg[8]_i_1_n_3\ : STD_LOGIC;
  signal \slow_counter_reg[8]_i_1_n_6\ : STD_LOGIC;
  signal \slow_counter_reg[8]_i_1_n_7\ : STD_LOGIC;
  signal NLW_pwm_out0_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_slow_counter_reg[8]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_slow_counter_reg[8]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
\pwm_counter[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\pwm_counter[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \pwm_counter[7]_i_5_n_0\,
      I4 => pwm_counter_reg(4),
      I5 => pwm_counter_reg(6),
      O => p_0_in(7)
    );
\pwm_counter[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F7FFFFFFFFFFFFFF"
    )
        port map (
      I0 => slow_counter_reg(7),
      I1 => slow_counter_reg(8),
      I2 => slow_counter_reg(0),
      I3 => slow_counter_reg(3),
      I4 => slow_counter_reg(9),
      I5 => slow_counter_reg(6),
      O => \pwm_counter[7]_i_4_n_0\
    );
\pwm_counter[7]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
pwm_out0_carry_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => pwm_counter_reg(7),
      I1 => pwm_out0_carry_0(7),
      I2 => pwm_out0_carry_0(6),
...
pwm_out0_carry_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => pwm_counter_reg(5),
      I1 => pwm_out0_carry_0(5),
      I2 => pwm_out0_carry_0(4),
...
pwm_out0_carry_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => pwm_counter_reg(3),
      I1 => pwm_out0_carry_0(3),
      I2 => pwm_out0_carry_0(2),
      I3 => pwm_counter_reg(2),
...
pwm_out0_carry_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"44D4"
        ...
        port map (
      I0 => pwm_counter_reg(1),
      I1 => pwm_out0_carry_0(1),
      I2 => pwm_out0_carry_0(0),
      I3 => pwm_counter_reg(0),
...
\slow_counter[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F7"
    )
        port map (
      ...
      O => \slow_counter[0]_i_1_n_0\
    );
\slow_counter[0]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => slow_counter_reg(0),
      O => \slow_counter[0]_i_3_n_0\
    );
\slow_counter_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[0]_i_2_n_7\,
      Q => slow_counter_reg(0),
      R => \slow_counter[0]_i_1_n_0\
    );
\slow_counter_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \slow_counter_reg[0]_i_2_n_0\,
      CO(2) => \slow_counter_reg[0]_i_2_n_1\,
      CO(1) => \slow_counter_reg[0]_i_2_n_2\,
      CO(0) => \slow_counter_reg[0]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
      O(3) => \slow_counter_reg[0]_i_2_n_4\,
      O(2) => \slow_counter_reg[0]_i_2_n_5\,
      O(1) => \slow_counter_reg[0]_i_2_n_6\,
      O(0) => \slow_counter_reg[0]_i_2_n_7\,
      S(3 downto 1) => slow_counter_reg(3 downto 1),
      S(0) => \slow_counter[0]_i_3_n_0\
    );
\slow_counter_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[0]_i_2_n_6\,
...
\slow_counter_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[4]_i_1_n_7\,
      Q => slow_counter_reg(4),
      R => \slow_counter[0]_i_1_n_0\
    );
\slow_counter_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \slow_counter_reg[0]_i_2_n_0\,
      CO(3) => \slow_counter_reg[4]_i_1_n_0\,
      CO(2) => \slow_counter_reg[4]_i_1_n_1\,
      CO(1) => \slow_counter_reg[4]_i_1_n_2\,
      CO(0) => \slow_counter_reg[4]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \slow_counter_reg[4]_i_1_n_4\,
      O(2) => \slow_counter_reg[4]_i_1_n_5\,
      O(1) => \slow_counter_reg[4]_i_1_n_6\,
      O(0) => \slow_counter_reg[4]_i_1_n_7\,
      S(3 downto 0) => slow_counter_reg(7 downto 4)
    );
\slow_counter_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[4]_i_1_n_6\,
...
\slow_counter_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[4]_i_1_n_5\,
      Q => slow_counter_reg(6),
      R => \slow_counter[0]_i_1_n_0\
    );
\slow_counter_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[4]_i_1_n_4\,
      Q => slow_counter_reg(7),
      R => \slow_counter[0]_i_1_n_0\
    );
\slow_counter_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[8]_i_1_n_7\,
      Q => slow_counter_reg(8),
      R => \slow_counter[0]_i_1_n_0\
    );
\slow_counter_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \slow_counter_reg[4]_i_1_n_0\,
      CO(3 downto 1) => \NLW_slow_counter_reg[8]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \slow_counter_reg[8]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_slow_counter_reg[8]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \slow_counter_reg[8]_i_1_n_6\,
      O(0) => \slow_counter_reg[8]_i_1_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => slow_counter_reg(9 downto 8)
    );
\slow_counter_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \slow_counter_reg[8]_i_1_n_6\,
      Q => slow_counter_reg(9),
      R => \slow_counter[0]_i_1_n_0\
    );
end STRUCTURE;
library IEEE;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP_slave_lite_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP_slave_lite_v1_0_S00_AXI : entity is "Axi_Pwm_IP_slave_lite_v1_0_S00_AXI";
end axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP_slave_lite_v1_0_S00_AXI is
...
pwm_inst: entity work.axi_pwm_test_Axi_Pwm_IP_0_0_pwm
     port map (
      Q(0) => slv_reg0(0),
      pwm_out => pwm_out,
      pwm_out0_carry_0(7 downto 0) => slv_reg1(7 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP : entity is "Axi_Pwm_IP";
end axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP;

architecture STRUCTURE of axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP is
begin
Axi_Pwm_IP_slave_lite_v1_0_S00_AXI_inst: entity work.axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP_slave_lite_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity axi_pwm_test_Axi_Pwm_IP_0_0 is
  port (
    pwm_out : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of axi_pwm_test_Axi_Pwm_IP_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axi_pwm_test_Axi_Pwm_IP_0_0 : entity is "axi_pwm_test_Axi_Pwm_IP_0_0,Axi_Pwm_IP,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of axi_pwm_test_Axi_Pwm_IP_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of axi_pwm_test_Axi_Pwm_IP_0_0 : entity is "Axi_Pwm_IP,Vivado 2025.2";
end axi_pwm_test_Axi_Pwm_IP_0_0;

architecture STRUCTURE of axi_pwm_test_Axi_Pwm_IP_0_0 is
...
inst: entity work.axi_pwm_test_Axi_Pwm_IP_0_0_Axi_Pwm_IP
     port map (
