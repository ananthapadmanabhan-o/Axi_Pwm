...
#
# Script generated by Vivado on Fri May 29 15:10:10 IST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_pwm_test.sh
...
#
# Usage        : axi_pwm_test.sh
#                axi_pwm_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_pwm_test.sh [-rerun]
#                axi_pwm_test.sh [-reset_run]
#                axi_pwm_test.sh [-clean]
#                axi_pwm_test.sh [-reset_log]
#                axi_pwm_test.sh [-help]
#
...
#                script (type 'axi_pwm_test.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname microblaze_v11_0_16 -libname xil_defaultlib -libname lmb_v10_v3_0_16 -libname lmb_bram_if_cntlr_v4_0_27 -libname blk_mem_gen_v8_4_12 -libname axi_lite_ipif_v3_0_4 -libname mdm_v3_2_29 -libname proc_sys_reset_v5_0_17 -libname smartconnect_v1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_36 -libname axi_vip_v1_1_22 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm microblaze_v11_0_16 xil_defaultlib lmb_v10_v3_0_16 lmb_bram_if_cntlr_v4_0_27 blk_mem_gen_v8_4_12 axi_lite_ipif_v3_0_4 mdm_v3_2_29 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 axi_vip_v1_1_22)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_pwm_test.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_pwm_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  "../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/42f3/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  "../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_36 $xmvlog_opts +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
  "../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/bc4b/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_22 $xmvlog_opts -sv +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/a415" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/00fe/hdl/verilog" +incdir+"../../../../Axi_Pwm_Test.gen/sources_1/bd/axi_pwm_test/ipshared/ec67/hdl" +incdir+"../../../../../../../../../tools/Xillinx/2025.2/data/rsb/busdef" +incdir+"/tools/Xillinx/2025.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_pwm_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_pwm_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_pwm_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_pwm_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_pwm_test.sh [-help]\n\
Usage: axi_pwm_test.sh [-step]\n\
Usage: axi_pwm_test.sh [-lib_map_path]\n\
Usage: axi_pwm_test.sh [-rerun]\n\
Usage: axi_pwm_test.sh [-reset_run]\n\
Usage: axi_pwm_test.sh [-clean]\n\
Usage: axi_pwm_test.sh [-reset_log]\n\
Usage: axi_pwm_test.sh [-keep_index]\n\
Usage: axi_pwm_test.sh [-noclean_files]\n\n\
